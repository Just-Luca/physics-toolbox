...
// ./esercizio01 dati.txt risultati.txt
...
int main (int argc, char** argv) {
	...
	if (argc < 3) { // verifico che vengano passati almeno due parametri da riga 
		...
		std::cout << "\t./esercizio01 dati.txt risultati.txt\n";
		return 1;
	}
	...
	std::vector<double> vec2; // N.B.: non mi serve sapere a priori quanti numeri dovrò 					     salvare
