...
int main()
{
  ...
  int NbinX = (xmax-xmin) / PIXELSIZE;
  int NbinY = (ymax-ymin) / PIXELSIZE;
  int M = 100;

  TH2D histo2d("isto_name","histo_title", NbinX, xmin, xmax, NbinY, ymin, ymax);
  ...
  TCanvas c1("c1","Mandelbrot",0,0,900,600);
  c1.cd();
