...
class planet
{
 public:
  ...
  void   DoStep          (planet& pl1, planet& pl2, double dt); // Aggiorna i vettori posizione e velocita` dopo un intervallo di tempo dt,
                         // calcolando l'accelerazione a cui e` soggetto il corpo celeste per la forza di gravità esercitata da pl1 e pl2
