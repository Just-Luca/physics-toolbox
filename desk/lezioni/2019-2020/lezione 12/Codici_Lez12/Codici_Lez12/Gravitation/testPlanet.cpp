...
int main()
{
  ...
  TCanvas c1("c1","Gravitation",0, 0, 800, 800);
  c1.SetFrameFillColor(kBlue);

  TGraph traiett_Terra;
  TGraph traiett_Marte;
  TGraph traiett_Sole;
