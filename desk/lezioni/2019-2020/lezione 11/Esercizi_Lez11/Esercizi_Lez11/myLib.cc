...
// #################################
double Statistics::fSin (double x)
{
  return 1 + sin(x);
}
...
// #######################################
bool Statistics::HitMiss_Sin (double xMin, double xMax, double yMin, double yMax)
{
  double x = 0., y = 0.;
  ...
  if (y < Statistics::fSin(x)) return true;
  else return false;
}
...
bool HitMiss_Gauss (double xMin, double xMax, double yMin, double yMax)
{
  ...
  if (y < Statistics::fGauss(x, 0, 1)) return true;
  else return false;
}
...
bool HitMiss_Exp (double xMin, double xMax, double yMin, double yMax)
{
  ...
  if (y < Statistics::fExp(x,MU)) return true;
  else return false;
}
...
double Statistics::fPI (double x)
{
  return 2 * sqrt(1 - x*x);
}

bool Statistics::HitMiss_PI (double xMin, double xMax, double yMin, double yMax)
{
  double x = 0., y = 0.;
  ...
  if (y < Statistics::fPI(x)) return true;
  else return false;
}

double Statistics::Crude_MC_PI (double xMin, double xMax)
{
  double x = 0., y = 0.;
